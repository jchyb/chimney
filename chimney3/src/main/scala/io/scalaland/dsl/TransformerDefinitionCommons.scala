...
trait TransformerDefinitionCommons[UpdateCfg[_ <: TransformerCfg]] {
  ...
  /** Used internally by macro. Please don't use in your code.
    */
  transparent inline def __refineConfig[C1 <: TransformerCfg]: UpdateCfg[C1] =
    this.asInstanceOf[UpdateCfg[C1]]

  /** Used internally by macro. Please don't use in your code.
    */
  transparent inline def __addOverride(key: String, value: Any): this.type =
    updated(overrides.updated(key, value), instances)

  /** Used internally by macro. Please don't use in your code.
    */
  transparent inline def __addInstance(from: String, to: String, value: Any): this.type =
